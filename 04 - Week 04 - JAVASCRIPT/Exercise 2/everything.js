...
// Bonus: Add a method to the object that will return a string with the first name and last
let me = {
    name: 'Usisipho',
    surname: 'Mxinwa',
    age: '23',
    favouriteColour: 'Black',
    dreamCar: 'Pagani Huayra',
    get fullname(){
        return this.name +' '+ this.surname;
}}

console.log((me.fullname)); // DOT NOTATION

// Create and add a new property and value of ‘favourite food’ to the object. //. Now delete the age property from the object

me.favouritefood = 'ICHIRAKU RAMEN' // ADDING NEW PROPERTY
